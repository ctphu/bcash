    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("BCash") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  bcash-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the BCash in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BCASH, 0.1 BCASH, 1 BCASH and 10 BCASH -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://bcashpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://bcashpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("BCash is shutting down...") + "<br /><br />" +
